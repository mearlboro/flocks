...
neighbours_in_reflective_bounds = np.array(
    [[4, 4], [2, 2], [2, 2.8], [2.5, 2.5], [3, 3], [4, 4.1], [0.1, 0.1], [0, 5], [0, 0]])
...
@pytest.mark.parametrize('i,actual,expected', [
    ...
    [20, neighbours(1, neighbours_in_reflective_bounds, 1, EnumNeighbours.METRIC, EnumBounds.REFLECTIVE), [1, 2, 3]],
    [21, neighbours(0, neighbours_in_reflective_bounds, 0.11, EnumNeighbours.METRIC, EnumBounds.REFLECTIVE), [0, 5]],
    [22, neighbours(0, neighbours_in_reflective_bounds, 0.1, EnumNeighbours.METRIC, EnumBounds.REFLECTIVE), [0]],
    [23, neighbours(1, neighbours_in_reflective_bounds, 3, EnumNeighbours.TOPOLOGICAL, EnumBounds.REFLECTIVE),
     [1, 3, 2, 4]],
    [24, neighbours(0, neighbours_in_reflective_bounds, 3, EnumNeighbours.TOPOLOGICAL, EnumBounds.REFLECTIVE),
     [0, 5, 4, 3]],
    [25, neighbours(1, neighbours_in_reflective_bounds, 1, EnumNeighbours.METRIC, EnumBounds.PERIODIC, 5), [1, 2, 3]],
    [26, neighbours(0, neighbours_in_reflective_bounds, 1, EnumNeighbours.METRIC, EnumBounds.PERIODIC, 5), [0, 5]],
    [27, neighbours(1, neighbours_in_reflective_bounds, 5, EnumNeighbours.TOPOLOGICAL, EnumBounds.PERIODIC, 5),
     [1, 3, 2, 4, 6, 0]],
    [28, neighbours(0, neighbours_in_reflective_bounds, 5, EnumNeighbours.TOPOLOGICAL, EnumBounds.PERIODIC, 5),
     [0, 5, 4, 7, 8, 6]],
